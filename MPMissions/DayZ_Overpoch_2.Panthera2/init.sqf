...
DefaultMagazines = ["HandRoadFlare","ItemBandage","ItemPainkiller","RH_8Rnd_45cal_m1911","RH_8Rnd_45cal_m1911"];
DefaultWeapons = ["RH_m1911old","ItemFlashlight","ItemRadio","ItemCompass"];
...
DZE_selfTransfuse_Values = [8500,30,600]; // [blood amount given, infection chance %, cooldown in seconds]
//DZE_MissionLootTable = true; //Custom Loot
MaxDynamicDebris = 320; // Max number of random road blocks to spawn around the map
MaxVehicleLimit = 320; // Max number of random vehicles to spawn around the map
